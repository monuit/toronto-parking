...
export function PointsLayer({
  ...
  }, [filter, map, onViewportSummaryChange]);
  ...
  }, [map, visible, scheduleSummaryFetch, onViewportSummaryChange]);
  ...
  const pointLayer = {
    ...
    paint: {
      ...
      'circle-radius': [
        'interpolate',
        ['linear'],
        ['coalesce', ['get', 'count'], ['get', 'ticketCount'], 1],
        1, 4,
        25, 6,
        75, 9,
        150, 12
  ...
  return (
    <Source
      ...
      type="vector"
      tiles={[MAP_CONFIG.TILE_SOURCE.TICKETS]}
      minzoom={0}
      maxzoom={18}
    >
